...
ax1.plot(t_var[t_start_idx:],voltages_var[t_start_idx:],label = 'Applied Voltage',color = 'tab:red')
...
ax3.plot(t_var[t_start_idx:],parallel_var[t_start_idx:],label = 'Parallel Angular Momentum Loss')
